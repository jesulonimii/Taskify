...
import {HomeIcon, UserGroupIcon} from "@heroicons/react/24/outline/index.js";

function Sidebar(props) {
    return (
        <div className={`bg-white w-[23%] h-full flex flex-col py-8 px-8 border-r border-gray-300 ${props.className}`}>
            ...
            <div className="w-full h-[45%] my-5  rounded-md">
                ...
                <div className="flex py-2 px-2 cursor-pointer">
                    <UserGroupIcon className="w-6 text-gray-600 font-bold"/>
                    <p className="font-medium text-gray-600 mx-5 text-md">Team</p>
                </div>


            </div>
            <div className="w-full h-full mb-5 bg-gray-300 rounded-md">
